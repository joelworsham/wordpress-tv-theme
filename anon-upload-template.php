...
<?php } ?>
	...
	<p>
		<label for="wptv_video_producer_fullname"><?php esc_html_e( 'Video producer full name' ); ?></label>
		<input type="text" id="wptv_video_producer_fullname" name="wptv_video_producer_fullname" value="" />
	</p>
	<p>
